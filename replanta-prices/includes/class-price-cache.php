        ...
        return array(
            ...
            'mantenimiento' => array(
                ...
                'plans'    => array(
                    'semilla' => array(
                        'name'       => 'Plan Semilla',
                        'subtitle'   => 'Web corporativa, portfolio o blog profesional',
                        'featured'   => false,
                    ...
                    'raiz' => array(
                        'name'       => 'Plan Raíz',
                        'subtitle'   => 'Empresa que capta leads, reservas o contactos',
                        'featured'   => true,
                    ...
                    'ecosistema' => array(
                        ...
                        'subtitle'   => 'Proyecto estratégico con roadmap activo',
                        'featured'   => false,
                    ...
                    'ecommerce' => array(
                        ...
                        'is_addon'   => true,
                        'pid'        => '',
                        'cta_url'    => '/contacto/?src=care-hub&addon=ecommerce',
                        'price_m'    => 35.00,
                        'price_y'    => 0,
                        'price_suffix' => 'mes extra',
                        'prices'     => array(
                            'USD' => array( 'm' => 39, 'y' => 0 ),
                            'MXN' => array( 'm' => 790, 'y' => 0 ),
                            'COP' => array( 'm' => 169000, 'y' => 0 ),
                            'CLP' => array( 'm' => 39900, 'y' => 0 ),
                            'ARS' => array( 'm' => 65900, 'y' => 0 ),
                            'PEN' => array( 'm' => 149, 'y' => 0 ),
                        ),
                        'features'   => array(
                            array( 'text' => 'Backups cada 12h + retención fiscal de 90 días', 'tip' => 'Sobre la retención del plan base, se añade histórico extendido para escenarios de auditoría fiscal.' ),
                            array( 'text' => 'Staging obligatorio pre-update', 'tip' => 'En ecommerce no se actualiza en vivo. Todo cambio pasa por staging sin excepción.' ),
                            array( 'text' => 'Monitorización de checkout + pasarela', 'tip' => 'Además de uptime/HTTP, se valida carrito > checkout > confirmación y flujo de pago.' ),
                            array( 'text' => 'Ventanas fuera de horas pico', 'tip' => 'Las actualizaciones se programan según análisis de tráfico para reducir impacto comercial.' ),
